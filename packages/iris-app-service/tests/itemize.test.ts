 ...
 */
const PRESET = 'E:/sillyTavern/SillyTavern/data/default-user/OpenAI Settings/梦境思客V1-0425.json'
const REAL_CARD = 'E:/sillyTavern/SillyTavern/data/default-user/characters/银麒赎世.png'
