...
> 状态：已归档（2026-09-16）。原路径 `notes/st-compat/HANDOFF.md`。被 `../st-compat/PILOT-REPORT.md`（2026-09-14 联合验收）取代：本文 §4 列的四项剩余工作（UC-3 投影修复、证据固化、ST 1.18.0 对照、验收报告）在那份报告里全部有判定。保留作历史。
