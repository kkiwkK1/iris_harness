...
> 状态：已被取代（2026-09-16 记）。四个落点的实现随 PR #88（`2eccf30`）进入 `main`，当前缺口以 `docs/INFRASTRUCTURE-INTERFACES.md` §8 为准；本文只作历史底稿。因源码注释引用本文件路径，留在原地。下面这段 2026-09-15 的状态块与正文原样保留。
