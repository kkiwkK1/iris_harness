...
export const en = {
  ...
  proseBeautify: 'Prose beautify',
  proseBeautifyNote: 'Typeset the model’s prose — first-line indent, a paragraph rhythm that follows your text size, and dialogue lines set off from narration. Display only; the stored text is never touched.',
...
export const zh: Record<StringKey, string> = {
  ...
  proseBeautify: '正文美化',
  proseBeautifyNote: '给模型的正文排版：段首缩进、随字号缩放的段落节律、对话行与叙述分行。只动显示，不碰存下的文本。',
