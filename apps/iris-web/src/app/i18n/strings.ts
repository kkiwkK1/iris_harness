...
export const en = {
  ...
  pluginCenterExpectedRevision: 'Expected revision',
  pluginCenterActualRevision: 'Loaded revision',
...
export const zh: Record<StringKey, string> = {
  ...
  pluginCenterExpectedRevision: '期望 revision',
  pluginCenterActualRevision: '实际加载 revision',
