 ...
 * to 42.3 when the height reporter gained a second observer.
 *
 ...
 * precaution: at `FRAME_BUDGET_BYTES / FRAME_OVERHEAD_BYTES` ≈ 48 frames the
 ...
 *
 * 20 leaves about 1.2 MiB for content (overhead ≈ 860 KiB, 42%), and 20 live
